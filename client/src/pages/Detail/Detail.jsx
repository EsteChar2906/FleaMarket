...
import { loadProduct, shopingCar, subTotal } from '../../store/actions/index.js';
    ...
    <div className='tododetalle'>
      ...
      <div className='contenedordetalle' >
        ...
        <div className='todolootro'>
         ...
         <div className='caracteristicasgenerales'>
         <div className='condicion'>
          ...
          <button className='comprar' onClick={addToCar}>
                Add to my Car
          </button>
