  ...
  return (
    <div>
      ...
      <div className={styles.block__detail}>
        <div className={styles.block__detail_contenedorcero}>
          <div className={styles.block__detail_contenedor}>
              ...
              <div className={styles.block__detail_info}>
                <div className={styles.block__detail_info} >
                  ...
                  <div className={styles.block__detail_titulo}>{p.title}</div>
                    ...
                    <div className={styles.block__detail_precio}>Precio: ${p.price}</div>


                    <div className={styles.block__detail_caracteristicas}>
                      <div className={styles.block__detail_caracteristicasdatos}>
            ...
            <div className={styles.block__detail_contenedorreviews}>
              <Reviews/>
            </div>
...
export function Detail() {
  ...
  return (
    <div>
      ...
      <div className={styles.block__detail_info}>
        <div className={styles.block__detail_infouno}>
