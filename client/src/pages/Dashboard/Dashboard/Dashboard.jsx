          ...
          <div className={styles.container_div}>
            <div className={styles.header_div_profile}>
              <Link to="/profile" style={{ textDecoration: "none" }}>
                <img className={styles.logo_users} src={profilegeneral} />
              </Link>
              <Link to="/profile" style={{ textDecoration: "none" }}>
                <label className={styles.labels}>Profile</label>
              </Link>
            </div>
          </div>
          <div className={styles.container_div}>
        ...
        <aside className={styles.aside}>
          <div className={styles.asides_div}>
            <Link to="/dashboard" style={{ textDecoration: "none" }}>
              <img className={styles.logo_users} src={estadisticas} />
            </Link>
            <Link to="/dashboard" style={{ textDecoration: "none" }}>
              <label className={styles.aside_labels}>Dashboard</label>
            </Link>
          </div>
          <div className={styles.asides_div}>
            <Link to="/users" style={{ textDecoration: "none" }}>
              <img className={styles.logo_users} src={logousers} />
            </Link>
            <Link to="/users" style={{ textDecoration: "none" }}>
              <label className={styles.aside_labels}>Users</label>
            </Link>
          </div>
          <div className={styles.asides_div}>
            <Link to="/products">
              <img className={styles.logo_users} src={products} />
            </Link>
          ...
          <div className={styles.asides_div}>
            <Link to="/orders" style={{ textDecoration: "none" }}>
              <img className={styles.logo_users} src={order} />
            </Link>
            <Link
              to="/orders"
              style={{ textDecoration: "none" }}
              className={styles.aside_labels}
            >
              {" "}
              Orders{" "}
            </Link>
          ...
          <div className={styles.asides_div}>
            <Link to="/categories" style={{ textDecoration: "none" }}>
              <img className={styles.logo_users} src={categories} />
            </Link>
            <Link
              to="/categories"
              style={{ textDecoration: "none" }}
